...
```{r}
#| label: table-key-indicators
knitr::kable(summary(indicators), caption = "Summary of Key Indicators")
```

|    Indicator     | Minimum Value | Maximum Value |  Mean   | Median  |
|:----------------:|:-------------:|:-------------:|:-------:|:-------:|
|  GDP Per Capita  |      259      |    240,862    | 20,346  |  7,588  |
| Life Expectancy  |     53.00     |     85.38     |  72.42  |  73.51  |
| Total Population |    11,310     |   1.417e+09   | 36.54e6 | 6.465e6 |

: Summary statistics for GDP per capita, Life Expectancy, and Total Population

## Cross-References

As shown in **Figure @fig-gdp-density**, the distribution of GDP per capita across countries is highly skewed. Additionally, **Figure @fig-life-expectancy** demonstrates the relationship between life expectancy and GDP per capita, indicating a possible positive correlation between the two.

The key statistics for the selected indicators, including GDP per capita, life expectancy, and total population, are summarized in **Table @table-key-indicators**.
